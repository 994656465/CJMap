...
{
    _finishButton = [[UIButton alloc] initWithFrame:CGRectMake(0, CGRectGetHeight(self.bounds) - kFinishButtonHeight-TABBARSAFEAREAHEIGHT, CGRectGetWidth(self.bounds), kFinishButtonHeight+TABBARSAFEAREAHEIGHT)];
